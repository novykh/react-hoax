...
it("removes resource", () =>
  testFunctionAction(actions.removeResource, "1")({
...
it("batch updates resource", () =>
  testFunctionAction(actions.updateBatchResource, "1", [])({
...
it("starts process resource", () =>
  testFunctionAction(actions.startProcessResource, "1")({
    expectedType: actionTypes.startProcessResource,
    expectedValues: { id: "1" }
  }));

it("finishes process resource", () =>
  testFunctionAction(actions.doneProcessResource, "1")({
